...
The GHCR image can be found at:
...
To change the version, update the `HASKELL_VERSION` repository variable in GitHub.
...
```bash
docker push -a ghcr.io/frankhjung/docker-haskell
```

**Note:** GitHub Actions workflows automatically build and push images on push to master.
